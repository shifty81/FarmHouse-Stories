...
func _ready() -> void:
	...
	for count in debris_counts.values():
...
func trigger_havenport_visit() -> void:
	...
	print("📋 Havenport Representative has arrived!")
	print("Quest: Prove your farm's worth by earning ", farm_worth_goal, "g before the end of Spring.")
...
func debris_cleared_by_player(debris_type: String) -> void:
	...
	if debris_type in debris_counts and debris_counts[debris_type] > 0:
...
func prove_farm_worth() -> void:
	...
	print("✅ You've proven the farm's worth!")
	print("Havenport will reconsider their offer...")
...
func purify_creek() -> void:
	...
	creek_purified = true
	print("🌊 The Creek has been purified!")
